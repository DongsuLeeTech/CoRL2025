...
class RobotariumRunner(Runner):
    ...
    def collect(self, step):
        ...
        value, action, action_log_prob, rnn_states, rnn_states_critic, _, _ \
    ...
    def eval(self, total_num_steps):
        ...
        for eval_episode in range(self.num_eval_episodes):
            ...
            for eval_step in range(self.episode_length):
                ...
                eval_action, eval_rnn_states, comm_info, graph = self.trainer.policy.act(np.concatenate(eval_obs),
    ...
    def save(self, episode):
        ...
        torch.save(policy_actor, str(self.save_dir) + "/actor.th")
        policy_critic = self.trainer.policy.critic
        torch.save(policy_critic, str(self.save_dir) + "/critic.th")
        if self.trainer._use_valuenorm:
            policy_vnorm = self.trainer.value_normalizer
            torch.save(policy_vnorm, str(self.save_dir) + "/vnorm.th")
