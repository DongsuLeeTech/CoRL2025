...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=1 python ../evaluate/evaluate_VoCAL.py --env_name ${env} --algorithm_name ${algo} \
    ...
    --n_obs_head 1 --obs_enc_type rnn --use_vq_vae --code_size 256 --vq_temp 1.0 --eval_bit 0 --use_wandb\

done
# --skip_connect_final
# --meta_allow_respawn
# --meta_global_pos --meta_navi_pos
