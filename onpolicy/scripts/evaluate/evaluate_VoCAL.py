...
def main(args):
    ...
    print(Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                   0] + "/scripts/eval_metadrive_scripts"))
    model_dir = Path(os.path.split(os.path.dirname(os.path.abspath(__file__)))[
                   0] + "/scripts/eval_metadrive_scripts")
    ...
    # run experiments
    from onpolicy.runner.shared.VoCAL_evaluator import MetaDriveRunner
