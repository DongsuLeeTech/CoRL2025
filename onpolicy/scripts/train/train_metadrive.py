...
def main(args):
    ...
    if all_args.algorithm_name == "rmappo":
        ...
        print("u are choosing to use MAGIC, we set use_recurrent_policy to be True")
        all_args.use_recurrent_policy = True
        all_args.use_naive_recurrent_policy = False
    elif "mat" in all_args.algorithm_name:
        print("u are choosing to use mat-based methods, we set use_recurrent_policy to be False for now")
        all_args.use_recurrent_policy = False
        all_args.use_naive_recurrent_policy = False
    ...
    # run experiments
    from onpolicy.runner.shared.metadrive_runner import MetaDriveRunner
