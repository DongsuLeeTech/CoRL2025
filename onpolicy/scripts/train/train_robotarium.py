...
def main(args):
    ...
    if all_args.share_policy:
        from onpolicy.runner.shared.robotarium_runner import RobotariumRunner as Runner
    else:
        from onpolicy.runner.separated.robotarium_runner import RobotariumRunner as Runner
