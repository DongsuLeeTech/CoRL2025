...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0 python ../train/train_VoCAL.py --env_name ${env} --algorithm_name ${algo} \
    ...
    --n_obs_head 1 --obs_enc_type rnn --use_vq_vae --code_size 256 --vq_temp 1.0 --eval_bit 0 \
