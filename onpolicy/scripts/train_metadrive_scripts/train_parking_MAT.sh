...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=0 python ../train/train_MAT.py --env_name ${env} --algorithm_name ${algo} \
    ...
    --meta_comm_range 25 --meta_comm_max_num 4 --use_centralized_V \
    --comm_type 1 --num_comm_hops 4 --comm_hidden_size 128 --comm_num_heads 4 \
    --n_block 1 --n_head 4 --pos_embed --obs_pos_embed_start 20 --obs_pos_embed_end 22 \
